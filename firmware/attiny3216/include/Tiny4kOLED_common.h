...
static const uint8_t tiny4koled_init_defaults [] = {	// Initialization Sequence
...
static const uint8_t tiny4koled_init_128x64 [] = {
...
static const uint8_t tiny4koled_init_128x64br [] = {
	0xC8,         // Set COM Output Scan Direction
	0xA1,         // Set Segment Re-map. A0=address mapped; A1=address 127 mapped.
	0xAD, 0x30,   // Select internal IREF and higher current
	0x8D, 0x14    // Set DC-DC enable 7.5V (We can't see the screen without the charge pump on)
...
static const uint8_t tiny4koled_init_128x32 [] = {
...
static const uint8_t tiny4koled_init_128x32b [] = {
	0xA8, 0x1F,		// Set multiplex ratio(1 to 64)
	0xDA, 0x02,		// Set com pins hardware configuration
...
static const uint8_t tiny4koled_init_128x32br [] = {
	0xC8,			// Set COM Output Scan Direction
	0xA1,			// Set Segment Re-map. A0=column 0 mapped to SEG0; A1=column 127 mapped to SEG0.
	0xA8, 0x1F,		// Set multiplex ratio(1 to 64)
	0xDA, 0x02,		// Set com pins hardware configuration
...
static const uint8_t tiny4koled_init_72x40r [] = {
	0xC8,         // Set COM Output Scan Direction
	0xA1,         // Set Segment Re-map. A0=address mapped; A1=address 127 mapped.
	0xA8, 0x27,   // Set multiplex ratio(1 to 64)
	0x8D, 0x14    // Set DC-DC enable 7.5V (We can't see the screen without the charge pump on)
...
static const uint8_t tiny4koled_init_64x48r [] = {
	0xC8,         // Set COM Output Scan Direction
	0xA1,         // Set Segment Re-map. A0=address mapped; A1=address 127 mapped.
	0xA8, 0x2F,   // Set multiplex ratio(1 to 64)
	0x8D, 0x14    // Set DC-DC enable 7.5V (We can't see the screen without the charge pump on)
...
static const uint8_t tiny4koled_init_64x48br [] = {
	0xC8,         // Set COM Output Scan Direction
	0xA1,         // Set Segment Re-map. A0=address mapped; A1=address 127 mapped.
	0xA8, 0x2F,   // Set multiplex ratio(1 to 64)
	0xAD, 0x30,   // Select internal IREF and higher current
...
static const uint8_t tiny4koled_init_64x32 [] = {
	0xA8, 0x1F,   // Set multiplex ratio(1 to 64)
	0x8D, 0x14    // Set DC-DC enable 7.5V (We can't see the screen without the charge pump on)
};

// Initialization sequence for bright 64 x 32 screen
static const uint8_t tiny4koled_init_64x32b [] = {
	0xA8, 0x1F,   // Set multiplex ratio(1 to 64)
	0xAD, 0x30,   // Select internal IREF and higher current
	0x8D, 0x14    // Set DC-DC enable 7.5V (We can't see the screen without the charge pump on)
};
...
static const uint8_t tiny4koled_init_64x32r [] = {
	0xC8,         // Set COM Output Scan Direction
	0xA1,         // Set Segment Re-map. A0=address mapped; A1=address 127 mapped.
	0xA8, 0x1F,   // Set multiplex ratio(1 to 64)
	0x8D, 0x14    // Set DC-DC enable 7.5V (We can't see the screen without the charge pump on)
...
static const uint8_t tiny4koled_init_64x32br [] = {
	0xC8,         // Set COM Output Scan Direction
	0xA1,         // Set Segment Re-map. A0=address mapped; A1=address 127 mapped.
	0xA8, 0x1F,   // Set multiplex ratio(1 to 64)
	0xAD, 0x30,   // Select internal IREF and higher current
